...
- [JavaScript专题系列之数据类型](https://github.com/xiangxingchen/blog/issues/11)
...
- [ES6学习（四）之Promise的模拟实现](https://github.com/xiangxingchen/blog/issues/8)
- [ES6学习（五）之箭头函数](https://github.com/xiangxingchen/blog/issues/12)
